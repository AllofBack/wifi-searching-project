...
public class ApiService {
	...
	// GSON : JSON구조를 띄는 직렬 데이터를 JAVA의 객체로 역직렬화 / 직렬화 해주는 Library..어떻게 활용할지 알아보기
    ...
    public void load() {
        ...
        // 1000개씩 불러오는게 가능한 상태
        // 1000개씩 파싱후, 저장하는 내용을 DB 코드쪽에서 실행하니 COLUM IS NOT UNIQUE 에러 발생하기 때문에 해당 부분에서 wifiService.saveDB() 실행
